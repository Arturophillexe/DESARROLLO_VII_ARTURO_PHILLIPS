...
$miArray = ["soda","papas","dip sauce","globos","pastel"]; // Reemplaza esto con tu propio array
$miString = "comida, bebida, amigos, fiesta, juegos"; // Reemplaza esto con tu propio string
$miNumero = 50+20; // Reemplaza esto con tu propio número
