...
$misAmigos = ["gabriel","audrey","stephanie"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "javier", "miyagi"); // Reemplaza las comillas vacías con los nombres de tus amigos
...
array_push($playlist, ["Billie Jean", "Michael Jackson"], ["Like a Rolling Stone", "Bob Dylan"],["paranoid","black Sabbath"]);
