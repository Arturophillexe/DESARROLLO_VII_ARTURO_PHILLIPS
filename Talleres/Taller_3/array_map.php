...
$frutas = ["tralalero", "bombardiro", "tripi", "ballerina"];
$frutasMayusculas = array_map('strtoupper', $frutas);

echo "</br>brainrot originales: " . implode(", ", $frutas) . "</br>";
echo "brainrot en mayúsculas: " . implode(", ", $frutasMayusculas) . "</br>";

// Bonus: Usar array_map() con múltiples arrays
$nombres = ["Ana", "Carlos", "Beatriz","arturo","jose"];
$apellidos = ["García", "Rodríguez", "López","phillips","jose"];
