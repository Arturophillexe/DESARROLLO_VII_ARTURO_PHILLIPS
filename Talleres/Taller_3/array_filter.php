...
$palabras = ["auto", "casa", "elefante", "iglú", "oso", "uva", "zapato","ulcera","matriz","vector","incinerador","eleccion","imaginacion","eclair","gitana","avenida"];
...
$estudiantes = [
    ...
    ["nombre" => "xavier", "curso" => "Swift", "nota" => 71]
];
